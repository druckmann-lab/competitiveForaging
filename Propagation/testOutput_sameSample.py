...
ax[3, 0].imshow(-1*np.reshape(env[0,:].numpy(), (N, N)), cmap=cmap1, origin='lower')
ax[3, 0].imshow(np.reshape(label[0,:].detach().numpy(), (N, N)), cmap=cmap2, origin='lower')
ax[3, 0].imshow(np.reshape(pred[0,:].detach().numpy(), (N, N)), cmap=cmap3, origin='lower')
...
ax[3, 1].imshow(-1*np.reshape(env[1,:].numpy(), (N, N)), cmap=cmap1, origin='lower')
ax[3, 1].imshow(np.reshape(label[1,:].detach().numpy(), (N, N)), cmap=cmap2, origin='lower')
ax[3, 1].imshow(np.reshape(pred[1,:].detach().numpy(), (N, N)), cmap=cmap3, origin='lower')
